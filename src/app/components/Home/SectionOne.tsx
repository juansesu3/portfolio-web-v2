        ...
        <>
            <div className='flex md:flex-row flex-col gap-4 justify-between'>
                ...
                <div className='flex gap-4 w-full flex-col custom:flex-row'>
                    <Link href={`/${locale}/about`} className='border border-gray-100 flex flex-col justify-end gap-2 cursor-pointer rounded-2xl shadow-md p-4 w-full hover:-translate-y-1 transition-all duration-300 ease-in-out'>
                        <Image
