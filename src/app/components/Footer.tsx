          ...
          <div className='flex flex-col items-center justify-center gap-2'>
            <Link href="/" className="text-xl font-bold w-20 h-20 ">
              <Image
                ...
                width={400}
                height={200}
                className="transition-transform duration-500 ease-in-out hover:rotate-90"
              />
            </Link>
            <div className='flex flex-row '>
              <div className='transition-all duration-300 ease-in-out hover:-translate-y-1 cursor-pointer'>
