...
const services = [
  {
    ...
    description: "I build custom AI agents and intelligent systems that automate complex processes, providing deep insights and driving efficiency for your business.",
    keywords: ["OpenAI", "LangChain", "Python", "Automation"],
    accentColor: "#9333ea" // Tu color principal
  },
  {
    icon: FaCode,
    title: "Resilient Web Development",
    description: "Leveraging modern frameworks like Next.js and React, I create fast, scalable, and robust web applications that deliver exceptional user experiences.",
  ...
  },
  {
    ...
    description: "My design process is user-obsessed, focusing on creating interfaces that are not only beautiful but also intuitive, accessible, and engaging.",
...
const principles = [
    { icon: FaShieldAlt, name: "Resilience" },
    { icon: FaLightbulb, name: "Creativity" },
    { icon: FaUserCheck, name: "User-Centric" }
];
  ...
  return (
    <section className="w-full bg-white py-20 sm:py-28">
      ...
      >
        ...
        >
          How My Philosophy Becomes Your Advantage
        </motion.h2>
        <motion.p 
            variants={itemVariants} 
            className="mt-4 max-w-2xl mx-auto text-lg text-slate-600"
        >
          The "Never Give Up" mindset is more than a mantra—it's the engine that powers every project. It transforms complex challenges into elegant, resilient, and high-performing solutions.
        </motion.p>
      </motion.div>
      ...
      <motion.div
        ...
        variants={containerVariants}
      >
        <motion.h3 variants={itemVariants} className="text-2xl font-bold text-slate-800">My Guiding Principles</motion.h3>
      ...
      >
        <h3 className="text-3xl font-bold text-slate-900">Have a challenge in mind?</h3>
        <p className="mt-2 text-lg text-slate-600">Let's build something incredible together.</p>
        <motion.button 
